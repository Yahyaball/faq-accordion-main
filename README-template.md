...
I have learned about the forEach function that allows you to make the element clickable on all buttons, so all elements are interactable to show and hide answers. It gave me a headache the first time I tried to code with JavaScript.
